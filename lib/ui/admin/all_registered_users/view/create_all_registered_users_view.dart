...
class CreateAllRegisteredUsersView extends StatefulWidget {
  ...
  @override
  State<CreateAllRegisteredUsersView> createState() =>
      _CreateAllRegisteredUsersViewState();
}

class _CreateAllRegisteredUsersViewState
    extends State<CreateAllRegisteredUsersView> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<AllRegisteredUsersController>(
        create: (_) => AllRegisteredUsersController(),
        child: const AllRegisteredUsersScreen());
  }
}
