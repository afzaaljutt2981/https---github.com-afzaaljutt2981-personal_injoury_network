...
class CreateTermAndConditionsView extends StatefulWidget {
  ...
  @override
  State<CreateTermAndConditionsView> createState() => _CreateTermAndConditionsViewState();
}

class _CreateTermAndConditionsViewState extends State<CreateTermAndConditionsView> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<TermAndConditionsController>(
        create: (_) => TermAndConditionsController(), child: const TermAndConditionsView());
  }
}
